"use strict";
(function () {
  var scenario = new metadyn.Scenario("Raster 4 decompose", 'Draw');
  ...
  scenario.draw = function (array, zmax) {
    var resolution, innerResolution, graphicPixelWidth, graphicPixelHeight, imageHeight, imageWidth,
        graphicHeightIterator, graphicWidthIterator, graphicWidthBottomLimit, graphicHeightBottomLimit = 0, dataWidthRest, dataHeigthRest, h0w0, h0w1, h1w0, h1w1, dataWidthIterator, dataHeightIterator,
    ...
    graphicPixelWidth = imageWidth / innerResolution; // width of 1 computational px in drawing pxs
    graphicPixelHeight = imageHeight / innerResolution; // height of 1 computational px in drawing pxs
  ...
  metadyn.drawRaster4Decompose = scenario;
})();
